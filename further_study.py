...
def custom_append(input_list, value):
    ...
    input_list[:custom_len(input_list) + 1] = input_list + [value]
...
def custom_extend(input_list, second_list):
    ...
    """
    new_len = custom_len(input_list) + custom_len(second_list)
    input_list[:new_len] = input_list + second_list
...
def custom_insert(input_list, index, value):
    ...
    """
    #new_len is the length of the new input_list
    new_len = custom_len(input_list) + 1
    input_list[:new_len] = input_list[:index] + [value] + input_list[index:]
...
def custom_remove(input_list, value):
    ...
    """
    index_remove = None
    for ndx, item in enumerate(input_list):
        if item == value:
            index_remove = ndx
            break
...
def custom_equality(some_list, another_list):
    ...
    """
    if not custom_len(some_list) == custom_len(another_list):
        return False
    
    for ndx in range(custom_len(another_list)):
        if not some_list[ndx] == another_list[ndx]:
            return False
